...
namespace Seleznev_sharp_client
{
    ...
    class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            SendMessage(s, (int)Address.MIDDLEWARE, 0, MessageTypes.INIT);
            ...
            while (true)
            {
                ...
                endPoint = new IPEndPoint(IPAddress.Parse("127.0.0.1"), 55555);
                ...
                switch (choice)
                {
                    ...
                    case 3:
                        {
                            connect(s, endPoint);
                            SendMessage(s, (int)Address.MIDDLEWARE, myID, MessageTypes.EXIT);
                            if (m.Receive(s) == MessageTypes.CONFIRM)
                            {
                                Console.WriteLine("\nУспешно\n");
                            }
