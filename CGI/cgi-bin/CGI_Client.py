...
class CGI_Client:
    ...
    def MsgInit(self):
        Message.SendMessage(Addresses.MIDDLEWARE, MessageTypes.INIT);
    ...
    def MsgGet(self):
        m = Message.SendMessage(Addresses.MIDDLEWARE, MessageTypes.GETDATA);
    ...
    def MsgExit(self):
        Message.SendMessage(Addresses.MIDDLEWARE, MessageTypes.EXIT);
        json_data = {'result': True};
        PrintJson(json_data);
